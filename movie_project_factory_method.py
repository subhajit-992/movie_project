...
class OmdbDataProcessor(creator):
    def __init__(self, string):
        self.string = string
    ...
    def movie_year_in_int(self):
        ...
        movie_name_with_year = OmdbDataProcessor.movie_name_with_year(self)
        for i in movie_name_with_year:
            i[1] = int(i[1])
        return movie_name_with_year

#process both omdb and tastedive data
class TastediveOmdbDataProcessor(creator, taste_data):
    def __init__(self, string):
        self.string = string
    ...
    def movie_name_year_list(self):
        ...
        movie_from_tastename = TastediveOmdbDataProcessor.movie_from_taste_name(self)
        movie_name_year_list = []
        movie_name_year_list = TastediveOmdbDataProcessor.movie_year(self, movie_from_tastename)
    ...
    def movie_from_both(self):
        ...
        movie_name_year_list = []
        movie_name_year_list = TastediveOmdbDataProcessor.movie_name_year_list(self)
        movie_name_with_year_2 = []
        movie_name_with_year_2 = TastediveOmdbDataProcessor.movie_name_with_year(self)
    ...
    def movie_year_in_int(self):
        movie_name_with_year = []
        movie_name_with_year = TastediveOmdbDataProcessor.movie_from_both(self)
        for i in movie_name_with_year:
            i[1] = int(i[1])
        return movie_name_with_year
...
class sort_movie_type_1(sort_movie):
    ...
    def sort_movie_by_year(self):
        ...
        movie_name_with_year = []
        movie_name_with_year = TastediveOmdbDataProcessor.movie_year_in_int(self)
...
class sort_movie_type_2(sort_movie):
    ...
    def sort_movie_by_year(self):
        ...
        movie_name_with_year = []
        movie_name_with_year = OmdbDataProcessor.movie_year_in_int(self)
...
if __name__ == "__main__":
    client_code(TastediveOmdbDataProcessor(string))



#There are two object     OmdbDataProcessor(string)  ,     TastediveOmdbDataProcessor(string)
   #when you use OmdbDataProcessor(string) , you should use "creator.sort_movie_type_1.print_movie()" in client_code

   #when you use TastediveOmdbDataProcessor(string) , you should use "creator.sort_movie_type_2.print_movie()" in client_code